...
class LibrarianController extends SecureController
{
    ...
    public function create()
    {
        ...
        $custom_fields =  CustomFormUserFields::getCustomUserFields(4);
    ...
    public function store(LibrarianRequest $request)
    {
        ...
        CustomFormUserFields::storeCustomUserField(4, $user->id, $request);
    ...
    public function show(User $librarian)
    {
        ...
        $action = 'show';
        $custom_fields =  CustomFormUserFields::getCustomUserFieldValues(4,$librarian->id);
    ...
    public function edit(User $librarian)
    {
        ...
        $custom_fields =  CustomFormUserFields::fetchCustomValues(4,$librarian->id);
    ...
    public function update(LibrarianRequest $request, User $librarian)
    {
        ...
        CustomFormUserFields::updateCustomUserField(4, $librarian->id, $request);
        return redirect('/librarian');
    }
    ...
    public function data()
    {
        ...
        return Datatables::of($librarians)
            ->add_column('actions', '@if(!Sentinel::getUser()->inRole(\'admin\') || Sentinel::getUser()->inRole(\'super_admin\') || (Sentinel::getUser()->inRole(\'admin\') && Settings::get(\'multi_school\') == \'no\') || (Sentinel::getUser()->inRole(\'admin\') && in_array(\'librarian.edit\', Sentinel::getUser()->permissions)))
                                    ...
                                    <a href="{{ url(\'/librarian/\' . $id . \'/show\' ) }}" class="btn btn-primary btn-sm" >
                                     ...
                                     @if(!Sentinel::getUser()->inRole(\'admin\') || Sentinel::getUser()->inRole(\'super_admin\') || (Sentinel::getUser()->inRole(\'admin\') && Settings::get(\'multi_school\') == \'no\') || (Sentinel::getUser()->inRole(\'admin\') && in_array(\'librarian.delete\', Sentinel::getUser()->permissions)))
