...
class ParentController extends SecureController
{
    ...
    public function create()
    {
        ...
        $custom_fields =  CustomFormUserFields::getCustomUserFields(7);
    ...
    public function store(ParentRequest $request)
    {
        ...
        CustomFormUserFields::storeCustomUserField(7, $user->id, $request);
    ...
    public function show(User $parentStudent)
    {
        ...
        $action = 'show';
        $custom_fields =  CustomFormUserFields::getCustomUserFieldValues(7,$parentStudent->id);
    ...
    public function edit(User $parentStudent)
    {
        ...
        $custom_fields =  CustomFormUserFields::fetchCustomValues(7,$parentStudent->id);
    ...
    public function update(ParentRequest $request, User $parentStudent)
    {
        ...
        CustomFormUserFields::updateCustomUserField(7, $parentStudent->id, $request);
    ...
    public function data()
    {
        ...
        return Datatables::of($parents)
            ->add_column('actions', '@if(!Sentinel::getUser()->inRole(\'admin\') || Sentinel::getUser()->inRole(\'super_admin\') || (Sentinel::getUser()->inRole(\'admin\') && Settings::get(\'multi_school\') == \'no\') || (Sentinel::getUser()->inRole(\'admin\') && in_array(\'parent.edit\', Sentinel::getUser()->permissions)))
                                   ...
                                   @if(!Sentinel::getUser()->inRole(\'admin\') || Sentinel::getUser()->inRole(\'super_admin\') || (Sentinel::getUser()->inRole(\'admin\') && Settings::get(\'multi_school\') == \'no\') || (Sentinel::getUser()->inRole(\'admin\') && in_array(\'parent.delete\', Sentinel::getUser()->permissions)))
