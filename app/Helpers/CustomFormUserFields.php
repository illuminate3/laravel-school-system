...
{
    public static function getCustomUserFields($role_id, $custom_user_field_values = array())
    {
        $custom_user_fields = CustomUserField::whereRoleId($role_id)->get();
        $return = "";
    ...
    public static function putCustomHeads($role_id, $col_heads)
    {
        $custom_user_fields = CustomUserField::whereRoleId($role_id)->get();
        foreach ($custom_user_fields as $custom_field)
    ...
    public static function validateCustomUserField($role_id, $request)
    {
    ...
    public static function fetchCustomValues($role_id,$user_id)
    {
        $custom_user_fields = CustomUserField::where('role_id', $role_id)->get();
        $return = "";
        foreach ($custom_user_fields as $custom_field) {
    ...
    public static function getCustomUserFieldValues($role_id, $user_id)
    {
    ...
    public static function storeCustomUserField($role_id, $user_id, $request)
    {
        $custom_user_fields = CustomUserField::whereRoleId($role_id)->get();
        foreach ($custom_user_fields as $custom_field) {
    ...
    public static function updateCustomUserField($role_id, $user_id, $request)
    {
        $custom_user_fields = CustomUserField::whereRoleId($role_id)->get();
        foreach ($custom_user_fields as $custom_field) {
