...
class OptionController extends SecureController
{
    ...
    public function __construct(OptionRepository $optionRepository)
    {
        ...
        $this->categories = array(
            ...
            'borrowing_period' => 'Book borrowing periods');

        $this->show_categories = array('attendance_type', 'currency', 'book_category', 'borrowing_period');
    ...
    public function data($category = '__')
    {
        ...
        if ($category != "__") {
            ...
            $options->whereIn('category', $this->show_categories);
        }
