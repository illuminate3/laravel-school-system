...
class HumanResourceController extends SecureController
{
    ...
    public function create()
    {
        ...
        $custom_fields =  CustomFormUserFields::getCustomUserFields(3);
    ...
    public function store(TeacherRequest $request)
    {
        ...
        CustomFormUserFields::storeCustomUserField(3, $user->id, $request);
    ...
    public function show(User $human_resource)
    {
        ...
        $action = 'show';
        $custom_fields =  CustomFormUserFields::getCustomUserFields(3,$human_resource->id);
    ...
    public function edit(User $human_resource)
    {
        ...
        $custom_fields =  CustomFormUserFields::fetchCustomValues(3,$human_resource->id);
    ...
    public function update(TeacherRequest $request, User $human_resource)
    {
        ...
        CustomFormUserFields::updateCustomUserField(3, $human_resource->id, $request);
        return redirect('/human_resource');
    }
    ...
    public function delete(User $human_resource)
    {
        ...
        $custom_fields =  CustomFormUserFields::getCustomUserFieldValues(3,$human_resource->id);
    ...
    public function data()
    {
        ...
        return Datatables::of($human_resources)
            ->add_column('actions', '@if(!Sentinel::inRole(\'admin\') || (Sentinel::inRole(\'admin\') && in_array(\'human_resource.edit\', Sentinel::getUser()->permissions)))
