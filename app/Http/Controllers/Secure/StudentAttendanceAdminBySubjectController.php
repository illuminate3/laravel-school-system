...
class StudentAttendanceAdminBySubjectController extends SecureController
{
    ...
    public function index()
    {
        ...
        $sections = ['' => trans('attendances_by_subject.select_section')] + $this->sectionRepository->getAllForSchoolYearSchool(session('current_school_year'), session('current_school'))
