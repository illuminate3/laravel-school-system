...
class SliderController extends SecureController
{
    ...
    {
        $slider = Slider::orderBy('position')->select(array('id', 'title', 'content'));

        return Datatables::of($slider)
            ->add_column('actions', '<a href="#" class="btn btn-sm btn-default"><i class="fa fa-sort"></i> {{ trans("table.order") }}</a>
