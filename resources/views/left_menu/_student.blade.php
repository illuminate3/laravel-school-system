...
<div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
    <div class="menu_section">
        ...
        <ul class="nav side-menu">
            ...
            <li {!! (ends_with(Route::getCurrentRoute()->getPath(), 'online_exams') ? 'class="active" id="active"' : '') !!}>
            ...
            <li {!! (starts_with(Route::getCurrentRoute()->getPath(), 'exams') ? 'class="active" id="active"' : '') !!}>
