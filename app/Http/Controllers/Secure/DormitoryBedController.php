...
class DormitoryBedController extends SecureController
{
    ...
    public function data()
    {
        ...
        return Datatables::of($dormitoryBeds)
            ->add_column('actions', '@if(!Sentinel::getUser()->inRole(\'admin\') || (Sentinel::getUser()->inRole(\'admin\') && Settings::get(\'multi_school\') == \'no\') || Sentinel::getUser()->inRole(\'super_admin\') || (Sentinel::getUser()->inRole(\'admin\') && in_array(\'dormitorybed.edit\', Sentinel::getUser()->permissions)))
