...
class SettingController extends SecureController
{
    ...
    public function index()
    {
        ...
        return view('setting.index', compact('title', 'max_upload_file_size', 'options', 'opts', 'self_registration_role','themes'));
    }
    ...
    public function store(SettingRequest $request)
    {
        if ($request->hasFile('logo_file')) {
            ...
            Thumbnail::generate_image_thumbnail($destinationPath . $picture, $destinationPath . 'thumb_' . $picture,75,75);
